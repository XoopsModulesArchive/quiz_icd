...
class soap_transport_http extends nusoap_base
{
    ...
    public function connect($connection_timeout = 0, $response_timeout = 30)
    {
        ...
        if (1 == $this->persistentConnection && is_resource($this->fp)) {
            return true;
        }
    ...
    public function getResponse()
    {
        ...
        // close filepointer
        if (//(isset($this->incoming_headers['connection']) && $this->incoming_headers['connection'] == 'close') ||
...
<ul>
     ...
     * @param bool   $namespace   , tns namespace
...
class wsdl extends XMLSchema
{
    ...
    public function serializeType($name, $type, $value, $use = 'encoded')
    {
        ...
        if (mb_strpos($type, ':')) {
            ...
            if ($ns == $this->XMLSchemaVersion || ($this->getNamespaceFromPrefix($ns)) == $this->XMLSchemaVersion) {
    ...
    public function call($operation, $params = [], $namespace = '', $soapAction = '', $headers = false, $rpcParams = null)
    {
        ...
        if ('wsdl' == $this->endpointType && $opData = $this->getOperationData($operation)) {
            ...
            if ('literal' == $opData['input']['use']) {
                ...
                $payload = '<' . $this->wsdl->getPrefixFromNamespace($namespace) . ":$operation>" . $this->wsdl->serializeRPCParameters($operation, 'input', $params) . '</' . $this->wsdl->getPrefixFromNamespace($namespace) . ":$operation>";
            }
